...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"1149080c-1772-4b9d-abcc-9e988b1f21a2","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"1149080c-1772-4b9d-abcc-9e988b1f21a2","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"1149080c-1772-4b9d-abcc-9e988b1f21a2"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"interpolate":{"value":"step-before"},"fill":{"value":"steelblue"},"fillOpacity":{"value":0.4},"stroke":{"value":"steelblue"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"1149080c-1772-4b9d-abcc-9e988b1f21a2","values":[{"x":0.0014272206462919712,"y":0},{"x":0.08451909463231763,"y":304.0},{"x":0.1676109686183433,"y":263.0},{"x":0.2507028426043689,"y":235.0},{"x":0.3337947165903946,"y":242.0},{"x":0.4168865905764203,"y":192.0},{"x":0.499978464562446,"y":203.0},{"x":0.5830703385484717,"y":156.0},{"x":0.6661622125344974,"y":126.0},{"x":0.749254086520523,"y":74.0},{"x":0.8323459605065487,"y":101.0},{"x":0.9154378344925744,"y":59.0},{"x":0.9985297084786001,"y":45.0},{"x":1.0816215824646258,"y":0}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"1149080c-1772-4b9d-abcc-9e988b1f21a2\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"1149080c-1772-4b9d-abcc-9e988b1f21a2\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"1149080c-1772-4b9d-abcc-9e988b1f21a2\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :interpolate {:value \"step-before\"}, :fill {:value \"steelblue\"}, :fillOpacity {:value 0.4}, :stroke {:value \"steelblue\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"1149080c-1772-4b9d-abcc-9e988b1f21a2\", :values ({:x 0.0014272206462919712, :y 0} {:x 0.08451909463231763, :y 304.0} {:x 0.1676109686183433, :y 263.0} {:x 0.2507028426043689, :y 235.0} {:x 0.3337947165903946, :y 242.0} {:x 0.4168865905764203, :y 192.0} {:x 0.499978464562446, :y 203.0} {:x 0.5830703385484717, :y 156.0} {:x 0.6661622125344974, :y 126.0} {:x 0.749254086520523, :y 74.0} {:x 0.8323459605065487, :y 101.0} {:x 0.9154378344925744, :y 59.0} {:x 0.9985297084786001, :y 45.0} {:x 1.0816215824646258, :y 0})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
...
;; @@
;; =>
;;; {"type":"html","content":"<span class='clj-double'>0.3596851939330809</span>","value":"0.3596851939330809"}
;; <=
...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"5a7051cb-97da-419c-a72a-2e95be85bc9f","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"5a7051cb-97da-419c-a72a-2e95be85bc9f","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"5a7051cb-97da-419c-a72a-2e95be85bc9f"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"#FF29D2"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"5a7051cb-97da-419c-a72a-2e95be85bc9f","values":[{"x":0,"y":0.37181330660381356},{"x":1,"y":0.29275314951407005},{"x":2,"y":0.25470776627539543},{"x":3,"y":0.178810977880195},{"x":4,"y":0.14461463445136724},{"x":5,"y":0.11865879514327274},{"x":6,"y":0.19379728906821697},{"x":7,"y":0.04406318602055257},{"x":8,"y":0.03849107724846605},{"x":9,"y":0.017474489016950832},{"x":10,"y":0.011248471259466545},{"x":11,"y":0.020711144609878156},{"x":12,"y":0.4803097857609864},{"x":13,"y":0.23512149589788303},{"x":14,"y":0.0023094604280568926}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"5a7051cb-97da-419c-a72a-2e95be85bc9f\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"5a7051cb-97da-419c-a72a-2e95be85bc9f\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"5a7051cb-97da-419c-a72a-2e95be85bc9f\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"#FF29D2\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"5a7051cb-97da-419c-a72a-2e95be85bc9f\", :values ({:x 0, :y 0.37181330660381356} {:x 1, :y 0.29275314951407005} {:x 2, :y 0.25470776627539543} {:x 3, :y 0.178810977880195} {:x 4, :y 0.14461463445136724} {:x 5, :y 0.11865879514327274} {:x 6, :y 0.19379728906821697} {:x 7, :y 0.04406318602055257} {:x 8, :y 0.03849107724846605} {:x 9, :y 0.017474489016950832} {:x 10, :y 0.011248471259466545} {:x 11, :y 0.020711144609878156} {:x 12, :y 0.4803097857609864} {:x 13, :y 0.23512149589788303} {:x 14, :y 0.0023094604280568926})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
...
(def mean-policy (for [gas-cost gas-costs]
              	   (let [states (doquery :lmh tworoads gas-cost :number-of-particles 100)
...
;; @@
;; =>
;;; {"type":"vega","content":{"axes":[{"scale":"x","type":"x"},{"scale":"y","type":"y"}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"69fa67a9-24a1-4d06-86ce-5888fda9dcf0","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"69fa67a9-24a1-4d06-86ce-5888fda9dcf0","field":"data.y"}}],"marks":[{"type":"line","from":{"data":"69fa67a9-24a1-4d06-86ce-5888fda9dcf0"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"#FF29D2"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}],"data":[{"name":"69fa67a9-24a1-4d06-86ce-5888fda9dcf0","values":[{"x":0,"y":0.3675874328447035},{"x":1,"y":0.3155354914335795},{"x":2,"y":0.2486533366058317},{"x":3,"y":0.18895454812478926},{"x":4,"y":0.16108322010164086},{"x":5,"y":0.09833949825600763},{"x":6,"y":0.0768461785255041},{"x":7,"y":0.06259059918952636},{"x":8,"y":0.03240327503590268},{"x":9,"y":0.031009962088013678},{"x":10,"y":0.01338857663221404},{"x":11,"y":0.014402817188910219},{"x":12,"y":0.009192124254480202},{"x":13,"y":0.02073259696015582},{"x":14,"y":0.011851453396037846}]}],"width":400,"height":247.2187957763672,"padding":{"bottom":20,"top":10,"right":10,"left":50}},"value":"#gorilla_repl.vega.VegaView{:content {:axes [{:scale \"x\", :type \"x\"} {:scale \"y\", :type \"y\"}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"69fa67a9-24a1-4d06-86ce-5888fda9dcf0\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"69fa67a9-24a1-4d06-86ce-5888fda9dcf0\", :field \"data.y\"}}], :marks [{:type \"line\", :from {:data \"69fa67a9-24a1-4d06-86ce-5888fda9dcf0\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"#FF29D2\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}}], :data [{:name \"69fa67a9-24a1-4d06-86ce-5888fda9dcf0\", :values ({:x 0, :y 0.3675874328447035} {:x 1, :y 0.3155354914335795} {:x 2, :y 0.2486533366058317} {:x 3, :y 0.18895454812478926} {:x 4, :y 0.16108322010164086} {:x 5, :y 0.09833949825600763} {:x 6, :y 0.0768461785255041} {:x 7, :y 0.06259059918952636} {:x 8, :y 0.03240327503590268} {:x 9, :y 0.031009962088013678} {:x 10, :y 0.01338857663221404} {:x 11, :y 0.014402817188910219} {:x 12, :y 0.009192124254480202} {:x 13, :y 0.02073259696015582} {:x 14, :y 0.011851453396037846})}], :width 400, :height 247.2188, :padding {:bottom 20, :top 10, :right 10, :left 50}}}"}
;; <=
